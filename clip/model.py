...
class Transformer(nn.Module):
    def __init__(self, width: int, layers: int, heads: int, attn_mask: torch.Tensor = None, prompts_needed=0,
        ...
        if current_trainer == 'IVLP' or current_trainer == 'VPT':
            ...
            assert current_trainer in ['CLIP','PROMPTFL','GL_SVDMSE','GL_SVDMSE_HE','GLP_OT','FEDPGP','GL_SVDMSE_VSP', 'GL_SVDMSE_CGL', 'GL_SVDMSE_CGLA', 'GL_SVDMSE_CGLS', 'GL_SVDMSE_ADAPTIVE', 'GL_SVDMSE_ADAPTIVE_confgap']
